# Rollback procedure — Snapshot 20260626T224512Z (label: post_H3_asset_filter)
...
git reset --hard $(cat snapshots/SNAPSHOT_20260626T224512Z_post_H3_asset_filter/git_head.txt)

# If uncommitted changes were captured in a stash, reapply
STASH_SHA=$(cat snapshots/SNAPSHOT_20260626T224512Z_post_H3_asset_filter/git_stash_sha.txt)
[ -n "$STASH_SHA" ] && git stash apply "$STASH_SHA"
```

### Step 3 — Restore daemon state files
```bash
cp snapshots/SNAPSHOT_20260626T224512Z_post_H3_asset_filter/daemon_state.json live/state/ 2>/dev/null || true
cp snapshots/SNAPSHOT_20260626T224512Z_post_H3_asset_filter/heartbeat.txt    live/state/ 2>/dev/null || true
cp snapshots/SNAPSHOT_20260626T224512Z_post_H3_asset_filter/trades.jsonl     live/state/ 2>/dev/null || true
```
