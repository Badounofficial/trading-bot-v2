# Rollback procedure — Snapshot 20260626T165329Z (label: pre_H4_friction_realistic)
...
git reset --hard $(cat snapshots/SNAPSHOT_20260626T165329Z_pre_H4_friction_realistic/git_head.txt)

# If uncommitted changes were captured in a stash, reapply
STASH_SHA=$(cat snapshots/SNAPSHOT_20260626T165329Z_pre_H4_friction_realistic/git_stash_sha.txt)
[ -n "$STASH_SHA" ] && git stash apply "$STASH_SHA"
```

### Step 3 — Restore daemon state files
```bash
cp snapshots/SNAPSHOT_20260626T165329Z_pre_H4_friction_realistic/daemon_state.json live/state/ 2>/dev/null || true
cp snapshots/SNAPSHOT_20260626T165329Z_pre_H4_friction_realistic/heartbeat.txt    live/state/ 2>/dev/null || true
cp snapshots/SNAPSHOT_20260626T165329Z_pre_H4_friction_realistic/trades.jsonl     live/state/ 2>/dev/null || true
```
