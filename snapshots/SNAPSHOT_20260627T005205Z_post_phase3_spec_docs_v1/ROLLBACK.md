# Rollback procedure — Snapshot 20260627T005205Z (label: post_phase3_spec_docs_v1)
...
git reset --hard $(cat snapshots/SNAPSHOT_20260627T005205Z_post_phase3_spec_docs_v1/git_head.txt)

# If uncommitted changes were captured in a stash, reapply
STASH_SHA=$(cat snapshots/SNAPSHOT_20260627T005205Z_post_phase3_spec_docs_v1/git_stash_sha.txt)
[ -n "$STASH_SHA" ] && git stash apply "$STASH_SHA"
```

### Step 3 — Restore daemon state files
```bash
cp snapshots/SNAPSHOT_20260627T005205Z_post_phase3_spec_docs_v1/daemon_state.json live/state/ 2>/dev/null || true
cp snapshots/SNAPSHOT_20260627T005205Z_post_phase3_spec_docs_v1/heartbeat.txt    live/state/ 2>/dev/null || true
cp snapshots/SNAPSHOT_20260627T005205Z_post_phase3_spec_docs_v1/trades.jsonl     live/state/ 2>/dev/null || true
```
