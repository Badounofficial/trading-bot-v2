// Trading Bot V2 — Strategic Deck Builder
// Style: Midnight Quant. Dark backgrounds, gold accent, P&L green/red, cyan data, purple crypto accent.
// Output: /Users/mindcompletionbody/Desktop/trading-bot-v2/Trading_Bot_V2_Strategic_Deck.pptx
//
// Run: NODE_PATH=~/.npm-global/lib/node_modules node scripts/build_deck.js
...
// =============================================================================
{
  ...
  const items = [
    ...
    },
    {
      ...
      body: "Proprietary bot: no CASP licence required. Signals or copy-trading for third parties: licence mandatory. PFU at 31.4% in FR; DAC8 auto-reporting active.",
      accent: C.cyan,
    },
    {
  ...
  s.addText("Source: internal backtest commit fbf497a · ESMA MiCA · DGFiP / Hagnere Patrimoine 2026", {
...
// =============================================================================
{
  ...
  const quad = [
    ...
    { t: "THREATS", c: C.gold, items: [
        ...
        "PFU @ 31.4% (2026); BNC requalification if trading is intensive",
    ]},
  ];
...
// =============================================================================
{
  ...
  addBg(s, C.bg);
  addLeftAccent(s);
  addSlideTitle(s, "09  ·  REGULATORY & TAX", "MiCA in force, DAC8 live, PFU at 31.4%");
  ...
  const cards = [
    ...
    },
    {
      ...
      sub: "31.4% (12.8 IR + 18.6 SS)",
      body: [
        "Capital gains > €305 / year → declared via form 2086.",
        "Option for progressive IR scale if more favorable.",
        "Heavy bot activity → BNC requalification risk (worse than PFU).",
      ],
      c: C.gold,
    },
    {
      ...
      body: [
        "Crypto platforms auto-transmit history to French tax authority.",
        "Effective end of grey-zone declaration.",
...
// =============================================================================
{
  ...
  s.addText([
    ...
    { text: "Net of PFU 31.4% ", options: { color: C.textMuted } },
...
// ----- Write ------------------------------------------------------------------
pres.writeFile({ fileName: "/sessions/wizardly-gifted-hypatia/mnt/trading-bot-v2/Trading_Bot_V2_Strategic_Deck.pptx" })
